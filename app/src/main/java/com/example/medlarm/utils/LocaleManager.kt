...
class LocaleManager(base: Context): ContextWrapper(base)  {
    companion object {
        ...
        fun getLocalizedConfiguration(context: Context, prefLocaleCode: String): Configuration {
            ...
            return getLocalizedConfiguration(context, locale)
        }

        fun getLocalizedConfiguration(context: Context, locale: Locale): Configuration {
        ...
        fun getLocalizedContext(baseContext: Context, prefLocaleCode: String): Context {
            ...
            return if (!baseLocale.toString().equals(currentLocale.toString(), ignoreCase = true)) {
                val config = getLocalizedConfiguration(baseContext, currentLocale)
